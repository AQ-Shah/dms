                        ...
                        <div class="card widget-flat">
                            <div class="card-body">
                                ...
                                <h3 class="mt-3">
                                    ...
                                    <?php if (find_dispatch_commission_paid_month_before_last_by_user($userData['id']) > 0) { ?>
                                        <h4 class="mb-3" style="color:#3CE23C"> Received</h4> <?php } ?>
                                </h3>
                                <p class="mb-0 text-muted">
                                    ...
                                    <?php if (find_dispatch_commission_month_before_last_by_user($userData['id']) != 0) {
                                        if ((find_dispatch_commission_month_before_last_by_user($userData['id']) - find_dispatch_commission_paid_month_before_last_by_user($userData['id'])) == 0) {
                                            ...
                                            echo '<span class="text-danger me-2"><i class="mdi mdi-arrow-down-bold"></i> $' . (find_dispatch_commission_month_before_last_by_user($userData['id']) - find_dispatch_commission_paid_month_before_last_by_user($userData['id'])) . ' remaining </span>';
                                    } ?>
                                </p>
                            </div> <!-- end card-body-->
                        </div> <!-- end card-->
                        ...
                        <div class="card widget-flat">
                            <div class="card-body">
                                ...
                                <h3 class="mt-3">
                                    ...
                                    <?php if (find_dispatch_commission_paid_last_month_by_user($userData['id']) > 0) { ?>
                                        <h4 class="mb-3" style="color:#3CE23C"> Received</h4> <?php } ?>
                                </h3>
                                <p class="mb-0 text-muted">
                                    <span class="text-nowrap">Total dispatch :
                                    ...
                                    <?php if (find_dispatch_commission_last_month_by_user($userData['id']) != 0) {
                                        if ((find_dispatch_commission_last_month_by_user($userData['id']) - find_dispatch_commission_paid_last_month_by_user($userData['id'])) == 0) {
                                            ...
                                            echo '<span class="text-danger me-2"><i class="mdi mdi-arrow-down-bold"></i> $' . (find_dispatch_commission_last_month_by_user($userData['id']) - find_dispatch_commission_paid_last_month_by_user($userData['id'])) . ' remaining </span>';
                                    } ?>
                                </p>
                            </div> <!-- end card-body-->
                        </div> <!-- end card-->
                        ...
                        <div class="card widget-flat">
                            <div class="card-body">
                                ...
                                <h3 class="mt-3">
                                    ...
                                    <?php if (find_dispatch_commission_paid_this_month_by_user($userData['id']) > 0) { ?>
                                        <h4 class="mb-3" style="color:#3CE23C"> Received</h4> <?php } ?>
                                </h3>
                                <p class="mb-0 text-muted">
                                    <span class="text-nowrap">Total dispatch :
                                    ...
                                    <?php if (find_dispatch_commission_this_month_by_user($userData['id']) != 0) {
                                        if ((find_dispatch_commission_this_month_by_user($userData['id']) - find_dispatch_commission_paid_this_month_by_user($userData['id'])) == 0) {
                                            ...
                                            echo '<span class="text-danger me-2"><i class="mdi mdi-arrow-down-bold"></i> $' . (find_dispatch_commission_this_month_by_user($userData['id']) - find_dispatch_commission_paid_this_month_by_user($userData['id'])) . ' remaining </span>';
                                    } ?>
                                </p>
                            </div> <!-- end card-body-->
                        </div> <!-- end card-->
                        ...
                        <div class="card widget-flat">
                            <div class="card-body">
                                ...
                                <h3 class="mt-3">
                                    ...
                                    <?php if (find_dispatch_commission_paid_last_week_by_user($userData['id']) > 0) { ?>
                                        <h4 class="mb-3" style="color:#3CE23C"> Received</h4> <?php } ?>
                                </h3>
                                <p class="mb-0 text-muted">
                                    <span class="text-nowrap">Total dispatch :
                                    ...
                                    <?php if (find_dispatch_commission_last_week_by_user($userData['id']) != 0) {
                                        if ((find_dispatch_commission_last_week_by_user($userData['id']) - find_dispatch_commission_paid_last_week_by_user($userData['id'])) == 0) {
                                            ...
                                            echo '<span class="text-danger me-2"><i class="mdi mdi-arrow-down-bold"></i> $' . (find_dispatch_commission_last_week_by_user($userData['id']) - find_dispatch_commission_paid_last_week_by_user($userData['id'])) . ' remaining </span>';
                                    } ?>
                                </p>
                            </div> <!-- end card-body-->
                        </div> <!-- end card-->
                        ...
                        <div class="card widget-flat">
                            <div class="card-body">
                                ...
                                <h3 class="mt-3">
                                    ...
                                    <?php if (find_dispatch_commission_paid_this_week_by_user($userData['id']) > 0) { ?>
                                        <h4 class="mb-3" style="color:#3CE23C"> Received</h4> <?php } ?>
                                </h3>
                                <p class="mb-0 text-muted">
                                    <span class="text-nowrap">Total dispatch :
                                    ...
                                    <?php if (find_dispatch_commission_this_week_by_user($userData['id']) != 0) {
                                        if ((find_dispatch_commission_this_week_by_user($userData['id']) - find_dispatch_commission_paid_this_week_by_user($userData['id'])) == 0) {
                                            ...
                                            echo '<span class="text-danger me-2"><i class="mdi mdi-arrow-down-bold"></i> $' . (find_dispatch_commission_this_week_by_user($userData['id']) - find_dispatch_commission_paid_this_week_by_user($userData['id'])) . ' remaining </span>';
                                    } ?>
                                </p>
                            </div> <!-- end card-body-->
                        </div> <!-- end card-->
