               ...
               <ul class="topbar-menu d-flex align-items-center gap-3">
                   ...
                   <li class="dropdown">
                       <a class="nav-link dropdown-toggle arrow-none nav-user px-2" data-bs-toggle="dropdown" href="#"
                           ...
                           <img src="get_image.php?path=<?php echo urlencode($user['photo_path']); ?>" alt="Company Logo" height="50" class="rounded-circle">
                           </span>
       ...
       <div class="leftside-menu">
           ...
           <div class="h-100" id="leftside-menu-container" data-simplebar>
               ...
               <ul class="side-nav">
                   ...
                   <li class="side-nav-item">
                       <a href="list_carriers?only_available" aria-expanded="false" aria-controls="sidebarDashboards"
                           class="side-nav-link">
                           <i class="mdi mdi-truck font-22"></i>
                   ...
                   <li class="side-nav-item">
                       <a href="list_carriers?only_unavailable" aria-expanded="false" aria-controls="sidebarDashboards"
                           class="side-nav-link">
                           <i class="mdi mdi-truck-remove-outline font-22"></i>
                   ...
                   <li class="side-nav-item">
                       <a href="list_carriers?only_removed" aria-expanded="false" aria-controls="sidebarDashboards"
                           class="side-nav-link">
                           <i class="mdi mdi-truck-remove-outline font-22"></i>
                   ...
                   <?php if (check_access("list_sales_agent_carriers")){ ?>

                   <li class="side-nav-item">
                       <a href="list_sales_agent_carriers" aria-expanded="false" aria-controls="sidebarDashboards"
                           class="side-nav-link">
                           <i class="mdi mdi-truck-plus font-22"></i>
                           <span> My Sales </span>
                       </a>
                   </li>
