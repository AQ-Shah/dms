                    ...
                    <table class="table table-hover" id="currentTable">
                        <thead>
                            <tr>
                                ...
                                <th onclick="sortTable(2)">Number of Trucks <span class="sort-arrows"></span> </th>
                                <th onclick="sortTable(3)">Carrier Number <span class="sort-arrows"></span> </th>
                                <th onclick="sortTable(4)">Status <span class="sort-arrows"></span> </th>
