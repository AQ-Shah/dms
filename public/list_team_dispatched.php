<?php 
    ...
    $current_page = "list_team_dispatched";
	include("../includes/layouts/public_header.php"); 
   
	include("../includes/pagination/carriers_team_dispatched_data_fetch.php"); 
  ?>
<div class="container">
    <div class="row">
        <div class="col-12">
                    ...
                    <table class="table table-hover" id="currentTable">
                        <thead>
                            <tr>
                                ...
                                <th onclick="sortTable(3)">Driver Name <span class="sort-arrows"></span> </th>
                                <th onclick="sortTable(4)">from->to <span class="sort-arrows"></span> </th>
                                ...
                                <th onclick="sortTable(8)">Invoice Status <span class="sort-arrows"></span> </th>
